...
public class Login extends HttpServlet {
 ...
 @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u != null) {
            // Nếu xác thực thành công, tạo một phiên người dùng và chuyển hướng đến trang chính
            HttpSession session = request.getSession();
            session.setAttribute("userEmail", email); // Lưu thông tin người dùng trong phiên
            response.sendRedirect("homepage"); // Chuyển hướng đến trang chính
        } else {
