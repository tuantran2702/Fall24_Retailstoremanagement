...
<html lang="en">
    <head>
        <title>Delete Customer | Quản lý khách hàng</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item">Xóa khách hàng</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Xác nhận xóa khách hàng</h3>
                        <div class="tile-body">
                            <p>Bạn có chắc chắn muốn xóa khách hàng <strong>${customer.firstName} ${customer.lastName}</strong>?</p>
                            <form action="${pageContext.request.contextPath}/customer?action=delete" method="post">
                                <input type="hidden" name="id" value="${id}">
                                <p>Bạn có chắc chắn muốn xóa khách hàng với ID: ${customer.customerID}?</p>
