...
<html lang="en">
<head>
    <title>Update Category | Quản lý danh mục</title>
    <meta charset="utf-8">
                    ...
                    <div class="tile-body">
                        <form action="category" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="${category.getCategoryName()}" required>
                            </div>
                            <div class="form-group">
                                <label for="description">Mô tả:</label>
                                <input type="text" class="form-control" id="description" name="description" value="${category.getDescription()}" required>
                            </div>
