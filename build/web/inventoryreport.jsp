...
<body onload="time()" class="app sidebar-mini rtl">
              ...
              <tbody>
                <c:forEach var="item" items="${inventoryItems}">
                  <tr>
                    ...
                    <td>$<fmt:formatNumber value="${item.totalStockValue}" pattern="#,##0.00"/></td>
                  </tr>
                </c:forEach>
              </tbody>
            </table>
  ...
  <script type="text/javascript">
    var valueData = {
      ...
      datasets: [{
        ...
        data: [<c:forEach var="item" items="${inventoryItems}" varStatus="status">
                ${item.totalStockValue}${!status.last ? ',' : ''}
               </c:forEach>]
      }]
    };
    ...
    var ctxv = document.getElementById("valueChartDemo").getContext("2d");
    var valueChart = new Chart(ctxv, {
      type: 'bar',
      data: valueData,
      options: {
        responsive: true,
    ...
    var ctxq = document.getElementById("quantityChartDemo").getContext("2d");
    var quantityChart = new Chart(ctxq, {
      type: 'bar',
      data: quantityData,
      options: {
        responsive: true,
