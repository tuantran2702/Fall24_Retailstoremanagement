...
<html lang="en">
    <head>
        <title>Edit Customer Rank | Quản lý cấp bậc khách hàng</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item">Chỉnh sửa cấp bậc</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Chỉnh sửa cấp bậc khách hàng</h3>
                        <div class="tile-body">
                            <form action="${pageContext.request.contextPath}/customerRank?action=update" method="post">
                                <input type="hidden" name="id" value="${customerRank.rankID}">
                                <div class="form-group">
                                    <label for="rankName">Tên cấp bậc</label>
                                    <input type="text" class="form-control" id="rankName" name="name" value="${customerRank.rankName}" required>
                                </div>
                                <div class="form-group">
                                    <label for="minimumSpent">Chi tiêu tối thiểu</label>
                                    <input type="number" class="form-control" id="minimumSpent" name="minimumSpent" value="${customerRank.minimumSpent}" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Mô tả</label>
                                    <textarea class="form-control" id="description" name="description" required>${customerRank.description}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="discountPercent">Phần trăm giảm giá</label>
                                    <textarea class="form-control" id="discountPercent" name="discountPercent" required>${customerRank.discountPercent}</textarea>
                                </div>
