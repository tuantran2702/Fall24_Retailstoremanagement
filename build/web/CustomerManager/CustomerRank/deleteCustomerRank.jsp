...
<html lang="en">
    <head>
        <title>Delete Customer Rank | Quản lý cấp bậc khách hàng</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item">Xóa cấp bậc</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Xác nhận xóa cấp bậc khách hàng</h3>
                        <div class="tile-body">
                            <p>Bạn có chắc chắn muốn xóa cấp bậc <strong>${rank.rankName}</strong>?</p>
                            <form action="${pageContext.request.contextPath}/customerRank?action=delete" method="post">
                                <input type="hidden" name="id" value="${id}">
                                <p>Bạn có chắc chắn muốn xóa cấp bậc khách hàng với ID: ${id}?</p>
