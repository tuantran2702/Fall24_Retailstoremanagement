    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><a href="import">Danh sách kho hàng</a></li>
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form action="import" method="post">
                            ...
                            <input type="hidden" name="id" value="${importEntry.getImportID()}">
                            <div class="form-group">
                                <label for="name">UnitCost:</label>
                                <input type="text" class="form-control" id="name" name="name" value="${importEntry.getUnitCost()}" required>
                            </div>
