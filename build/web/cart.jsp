                                        ...
                                        <c:forEach items="${o.items}" var="i">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="number" readonly value="${i.getQuantity()}" max="${i.product.quantity}" class="quantity-input" />
                                                    <a href="process?num=1&productID=${i.product.productID}">+</a>
                                                </td>
                            ...
                            <c:if test="${not empty o.items}"> 
                                <form action="checkout" method="post">
                                    <div class="discount-code-container">
                                        ...
                                        <input type="text" id="discount-code" name="discountCode" class="discount-code-input" placeholder="Mã giảm giá"/>
                                    </div>
                                    <div class="payment-method-container">
                                        <label for="payment-method" class="payment-method-label">Chọn Phương Thức Thanh Toán:</label>
                                        <select id="payment-method" name="paymentMethod" class="payment-method-select" required>
                                    ...
                                    <div class="payment-button-container">
                                        <div class="total-amount-container">
                                            <span class="total-amount-label">Tổng Tiền: <fmt:formatNumber pattern="#,##0.00" value="${total}"/></span>
                                        </div>
